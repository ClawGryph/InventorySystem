...
<body>
    ...
    <script src="../admin/checkingStock.js"></script>
    <script src="../admin/changeView.js"></script>
    <script src="../admin/editSales.js"></script>
    <script src="../admin/displayMessageNotification.js"></script>
</body>
</html>